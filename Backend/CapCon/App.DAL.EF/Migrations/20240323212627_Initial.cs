        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppUserId = table.Column<Guid>(type: "uuid", nullable: false),
                    CompanyId = table.Column<Guid>(type: "uuid", nullable: false),
                    LoanRequestId = table.Column<Guid>(type: "uuid", nullable: true),
                    Amount = table.Column<decimal>(type: "numeric", nullable: false),
                    Interest = table.Column<decimal>(type: "numeric", nullable: false),
                    Period = table.Column<int>(type: "integer", nullable: false),
                    Active = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoanOffers_AppUserId",
                table: "LoanOffers",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_LoanOffers_CompanyId",
                table: "LoanOffers",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_LoanOffers_LoanRequestId",
                table: "LoanOffers",
                column: "LoanRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_LoanRequests_CompanyId",
                table: "LoanRequests",
                column: "CompanyId");
